...
class FarmerWeatherPreference(models.Model):
    ...
    alert_threshold_rain = models.DecimalField(max_digits=5, decimal_places=2, default=10.0)
    alert_threshold_temp = models.DecimalField(max_digits=5, decimal_places=2, default=5.0)
    alert_threshold_wind = models.DecimalField(max_digits=5, decimal_places=2, default=30.0)
