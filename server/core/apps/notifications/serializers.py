...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'channels', 'related_model', 'related_id', 'is_read',
            'is_sent', 'send_attempts', 'data', 'created_at',
            'sent_at', 'read_at'
        ]
...
class NotificationPreferenceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'email_new_order', 'email_order_updates',
            'email_payment', 'email_marketing', 'push_new_message',
            'push_order_updates', 'push_weather_alerts', 'push_system',
            'in_app_all', 'sms_urgent', 'created_at', 'updated_at'
        ]
...
class PushSubscriptionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'endpoint', 'subscription_info',
