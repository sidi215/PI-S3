...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('welcome', 'Bienvenue'), ('new_order', 'Nouvelle commande'), ('order_accepted', 'Commande acceptée'), ('order_shipped', 'Commande expédiée'), ('order_delivered', 'Commande livrée'), ('order_cancelled', 'Commande annulée'), ('new_message', 'Nouveau message'), ('weather_alert', 'Alerte météo'), ('low_stock', 'Stock faible'), ('new_review', 'Nouvel avis'), ('payment_received', 'Paiement reçu'), ('payout_sent', 'Paiement envoyé'), ('system', 'Système')], max_length=50)),
                ('title', models.CharField(max_length=200)),
                ('message', models.TextField()),
                ('channels', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('email', 'Email'), ('push', 'Notification push'), ('in_app', "Dans l'application"), ('sms', 'SMS')], max_length=20), default=list)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'is_read', 'created_at'], name='notificatio_user_id_8a7c6b_idx'), models.Index(fields=['notification_type', 'created_at'], name='notificatio_notific_f2e0f7_idx')],
            },
        ),
    ]
