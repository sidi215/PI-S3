    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farmer', models.OneToOneField(limit_choices_to={'user_type': 'farmer'}, on_delete=django.db.models.deletion.CASCADE, related_name='analytics', to=settings.AUTH_USER_MODEL)),
            ],
            options={
