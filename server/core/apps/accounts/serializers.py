...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserProfile
        fields = ('language', 'currency', 'notifications_enabled',
                 'completed_orders', 'failed_orders')
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'user_type', 'phone_number', 'address', 'city', 'wilaya',
            'profile_picture', 'bio', 'farm_name', 'farm_size_hectares',
            'farm_location', 'is_verified', 'rating', 'total_sales',
            'date_joined', 'profile'
        )
