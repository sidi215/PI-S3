...
class User(AbstractUser):
    ...
    city = models.CharField(
        max_length=100, choices=CITIES, blank=True, verbose_name="Ville"
    )
    ...
    farm_location = models.CharField(
        max_length=500, blank=True, verbose_name="Localisation de la ferme"
    )

    crop_types = models.JSONField(
        default=list, blank=True, verbose_name="Types de cultures"
    )
    ...
    is_active_farmer = models.BooleanField(
        default=True, verbose_name="Agriculteur actif"
    )
    ...
    completed_orders = models.IntegerField(
        default=0, verbose_name="Commandes complétées"
    )
    ...
    currency = models.CharField(
        max_length=3, default="MRU", verbose_name="Devise préférée"
    )

    receive_email_notifications = models.BooleanField(
        default=True, verbose_name="Recevoir les notifications par email"
    )
...
class UserProfile(models.Model):
    ...
    secondary_email = models.EmailField(blank=True, verbose_name="Email secondaire")

    secondary_phone = models.CharField(
        max_length=15, blank=True, verbose_name="Téléphone secondaire"
    )
    ...
    company_name = models.CharField(
        max_length=200, blank=True, verbose_name="Nom de l'entreprise"
    )

    # Pour les agriculteurs
    farm_registration_number = models.CharField(
        max_length=100, blank=True, verbose_name="Numéro d'enregistrement de la ferme"
    )

    farm_certifications = models.JSONField(
        default=list, blank=True, verbose_name="Certifications de la ferme"
    )
    ...
    preferred_product_categories = models.JSONField(
        default=list, blank=True, verbose_name="Catégories de produits préférées"
    )
...
class UserVerification(models.Model):
    ...
    verification_notes = models.TextField(
        blank=True, verbose_name="Notes de vérification"
    )
...
class UserDevice(models.Model):
    ...
    device_id = models.CharField(
        max_length=100, blank=True, verbose_name="ID de l'appareil"
    )

    app_version = models.CharField(
        max_length=20, blank=True, verbose_name="Version de l'application"
    )

    os_version = models.CharField(
        max_length=20, blank=True, verbose_name="Version du système d'exploitation"
    )
