...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(
        "marketplace.Product", on_delete=models.PROTECT, related_name="order_items"
    )
    farmer = models.ForeignKey(
        "accounts.User", on_delete=models.PROTECT, related_name="order_items"
    )
    ...
    item_status = models.CharField(
        max_length=20, choices=OrderItemStatus.choices, default=OrderItemStatus.PENDING
    )
...
class CartItem(models.Model):
    ...
    product = models.ForeignKey(
        "marketplace.Product", on_delete=models.CASCADE, related_name="cart_items"
    )
    quantity = models.DecimalField(
        max_digits=10,
        decimal_places=2,
