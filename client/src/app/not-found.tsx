      ...
      <div className="container relative min-h-screen flex flex-col items-center justify-center px-4 py-16">
        <div className="w-full max-w-4xl mx-auto">
          ...
          >
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-2xl font-bold text-green-600 dark:text-green-400"
            >
          ...
          >
            ...
            <h1 className="text-4xl font-bold mb-4">Oups ! Page non trouvée</h1>

            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              La page que vous cherchez semble avoir été déplacée, supprimée ou
              n'existe peut-être pas. Ne vous inquiétez pas, nous pouvons vous
                ...
                <Link href="/marketplace">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Achetez des produits agricoles frais directement aux
                      producteurs
                    </p>
                  </CardContent>
                </Link>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/help">Consulter l'aide</Link>
              </Button>
            </div>
          </motion.div>
        </div>
