                ...
                <div className="rounded-md bg-green-50 p-4 flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-green-700">
                      Votre compte est maintenant entièrement activé. Vous
                      pouvez vous connecter et profiter de toutes les
                      fonctionnalités.
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-lg border p-4 space-y-3">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-amber-600 mt-1.5"></div>
                      <span>
                        Essayez de vous connecter - votre compte pourrait déjà
                        être vérifié
                      </span>
                    </li>
                  </ul>
