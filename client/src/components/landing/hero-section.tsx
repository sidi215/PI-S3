          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-2xl">
                Une plateforme agricole pensée pour les réalités de la Mauritanie : 
                diagnostic des cultures, gestion de l'eau et vente directe sans intermédiaires.
              </p>
            </motion.div>
            ...
            >
              <Button size="lg" asChild className="h-12 px-8 text-base group">
                <Link href="/auth/register?type=farmer" className="flex items-center justify-center gap-2">
